...
{
    public partial class add_company_product_segment : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateTime = table.Column<DateTime>(nullable: true),
                    UpdateBy = table.Column<string>(maxLength: 50, nullable: true),
                    InitialNum = table.Column<decimal>(nullable: false),
                    MaxNum = table.Column<decimal>(nullable: false),
                    Remain = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Segments_Products_ProductId",

...
namespace Ignite2019.IoT.Orleans.Controllers
{
  ...
  public partial class EventHistoryController : BaseController
  {
    ...
    public async Task<ActionResult> Logs(string id)
    {
      ...
      var vmHistories = shadowDevice.EventHistories.Select(e => e as EventHistory_View).ToList();
      vm.EntityList = vmHistories;
    ...
    public ActionResult MockDeviceEvent()
    {
      ...
      var deviceIds = this.DC.Set<Device>().Select(d => d.ID).Take(1000).ToList();

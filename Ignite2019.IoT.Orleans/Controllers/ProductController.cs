...
namespace Ignite2019.IoT.Orleans.Controllers
{
    ...
    public partial class ProductController : BaseController
    {
        ...
        {
            var vm = CreateVM<ProductListVM>();
            return PartialView(vm);
        }

        [ActionDescription("搜索")]
        [HttpPost]
        public string Search(ProductListVM vm)
        {
        ...
        {
            var vm = CreateVM<ProductBatchVM>(Ids: IDs);
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("批量修改")]
        public ActionResult DoBatchEdit(ProductBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("批量删除")]
        public ActionResult DoBatchDelete(ProductBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = CreateVM<ProductImportVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("导入")]
        public ActionResult Import(ProductImportVM vm, IFormCollection nouse)
        {
